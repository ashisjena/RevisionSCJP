...
public class ReadWriteLock
{
    ...
    {
        if ( isOnlyReader( callingThread ) )  // This calling Thread has acquired read lock and is the only reader.
            return true;
        if ( hasReaders() )  // If multiple readers have acquired read lock.
            return false;
