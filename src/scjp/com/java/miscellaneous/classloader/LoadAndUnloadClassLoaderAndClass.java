...
public class LoadAndUnloadClassLoaderAndClass
{
    ...
    {
        URL url = LoadAndUnloadClassLoaderAndClass.class.getProtectionDomain().getCodeSource().getLocation();
        final String className = LoadAndUnloadClassLoaderAndClass.class.getPackage().getName() + ".UtilityClass";
        {
            ClassLoader cl;
            Class clazz;
    ...
    private static class CustomClassLoader extends URLClassLoader
    {
        ...
        protected Class< ? > loadClass( String name, boolean resolve ) throws ClassNotFoundException
        {
            ...
            {
                return Class.forName( name, resolve, LoadAndUnloadClassLoaderAndClass.class.getClassLoader() );
            }
        }
